...
<div class='col-md-4 mb-3'>
                        <div class='card' style='width: 18rem;'>
                              <img src='./photos/milk3,jpg.jpg' class='card-img-top'>
                              <div class='card-body'>
                                <h5 class='card-title'>$product_title</h5>
                               <b> <p> $product_price <p> </b>
...
<img src="./photos/milk1.jpg" alt="" class="card-img-top">
            </div>
            <div class="col-md-6 mt-5">
            <img src="./photos/mik2.jpg" alt="" class="card-img-top">
            </div>
      </div>
</div> -->
